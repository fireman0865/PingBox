...
from .models import (
    ...
    Rack, RackGroup, RackReservation, RackRole, RearPort, RearPortTemplate, Region, Site, VirtualChassis,Application,ApplicationType,UnderSystem,UnderSystemType
)
...
class DeviceForm(BootstrapMixin, TenancyForm, CustomFieldModelForm):
    ...
    acquisition_date=forms.DateField(label='Acquisition Date for this device',widget=forms.SelectDateWidget)
    garantee_end_date=forms.DateField(label='Garantee End Date for this device',
    ...
    class Meta:
        ...
        fields = [
            ...
            'status','acquisition_date' ,'garantee_end_date','platform', 'primary_ip4', 'primary_ip6', 'cluster_group', 'cluster', 'tenant_group', 'tenant',
...
class DeviceCSVForm(BaseDeviceCSVForm):
    ...
    acquisition_date=forms.DateField(help_text="Acquisition Date for this equipment")
    garantee_end_date=forms.DateField(help_text="Garantee End Date")
    class Meta(BaseDeviceCSVForm.Meta):
        fields = [
            'name', 'device_role', 'tenant', 'manufacturer', 'model_name', 'platform', 'serial', 'asset_tag', 'status',
            'site', 'rack_group', 'rack_name', 'position', 'face', 'cluster', 'comments','acquisition_date','garantee_end_date'
        ]
...
class ApplicationForm(BootstrapMixin,forms.ModelForm):
    ...
    application_type = forms.ModelChoiceField(
        ...
        required=True,
        to_field_name='name',
        help_text='Application Type name',
        
        )
  
    vm_id = DynamicModelMultipleChoiceField(
        queryset=VirtualMachine.objects.all(),
        required=False,
    ...
    environnement=forms.ChoiceField(
        required=True,
        label='environnement',
        choices =add_blank_choice(EnvironnementChoices),
        widget=StaticSelect2()
    )
        
        
    version=forms.CharField(
        help_text='Version for this application',
        label='Version',
        required=False
    )
    application_team=forms.CharField(
        help_text='Team Accountable for this application',
        label='Application Team',
        required=False
    )
    link=forms.CharField(
        help_text='Link to this application',
        label='Link',
        required=False
    )
    application_maintainer=forms.CharField(
        help_text='Main Maintainer',
        label='Main Maintainer',
        required=False
    )
    ...
    class Meta:
        model = Application
        fields = [
            'name', 'slug', 'platform','application_type','vm_id','environnement','version','application_team','link','application_maintainer','scope',
            'undersystem','status','tenant','ip_adress'
            
        ]
       

class ApplicationCSVForm(forms.ModelForm):
    slug = SlugField()
    platform = forms.ModelChoiceField(
        queryset=Platform.objects.all(),
        required=False,
    ...
    application_type = DynamicModelChoiceField(
        queryset=ApplicationType.objects.all(),
        required=False,
        to_field_name='name',
        help_text='Application Type name',
    ...
    environnement=forms.ModelChoiceField(
        queryset=Application.objects.all(),
        required=True,
        to_field_name='environnement',
        help_text='Environnement used',
    ...
    undersystem=forms.ModelChoiceField(
        queryset=UnderSystem.objects.all(),
        required=False,
        to_field_name='name',
        help_text='UnderSystem',
    ...
    class Meta:
        model = Application
        fields = [
            'name', 'slug', 'platform','application_type','vm_id','environnement','version','application_team','lien','application_maintainer','scope','undersystem','status','tenant'
          
        ]

   
class ApplicationTypeForm(BootstrapMixin,forms.ModelForm):
    ...
    language=forms.ChoiceField(
        required=True,
        label='Language',
        choices =add_blank_choice(LanguageChoices),
        widget=StaticSelect2()
    )
    class Meta:
        model = ApplicationType
        fields = [
            'name', 'slug','platform','language'
        ]
       


class ApplicationTypeCSVForm(forms.ModelForm):
    name=forms.CharField()
    slug=forms.SlugField()
    platform = forms.ModelChoiceField(
        queryset=Platform.objects.all(),
...
class UnderSystemForm(BootstrapMixin,forms.ModelForm):
    ...
    undersystem_type = forms.ModelChoiceField(
        queryset=UnderSystemType.objects.all(),
        required=False,
    ...
    version=forms.CharField(
        max_length=100,
        help_text='Version for this system',
    )

    class Meta:
        model = UnderSystem
        fields = [
            'name', 'slug', 'platform','undersystem_type','virtual_machine','version'
        ]
    



class UnderSystemCSVForm(forms.ModelForm):
    name = forms.CharField()
...
class UnderSystemTypeForm(BootstrapMixin,forms.ModelForm):
    name = forms.CharField(
    ...
    description=forms.CharField(
        max_length=100,
        help_text='Description for this system',
    )
...
class UnderSystemTypeCSVForm(forms.ModelForm):
    name = forms.CharField()
    slug = forms.SlugField()
    description=forms.CharField(
        max_length=100,
