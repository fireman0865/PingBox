...
class Device(ChangeLoggedModel, ConfigContextModel, CustomFieldModel):
    ...
    garantee_end_date=models.DateField(null=True,blank=True)
    custom_field_values = GenericRelation(
        to='extras.CustomFieldValue',
        content_type_field='obj_type',
        object_id_field='obj_id'
...
class Application(ChangeLoggedModel):
    ...
    application_type = models.ForeignKey(
        to='dcim.ApplicationType',
        on_delete=models.PROTECT,
        related_name='application_type',
        blank=True,
        null=True,
        
        )
    undersystem = models.ForeignKey(
        to='dcim.Undersystem',
        on_delete=models.PROTECT,
        related_name='undersystem',
        blank=True,
        null=True,
    ...
    application_team=models.CharField(
        max_length=100,
        verbose_name='application_team',
    ...
    environnement = models.CharField(
        max_length=50,
        blank=True,
        choices=EnvironnementChoices,
        verbose_name='environnemnt'
    )
    application_maintainer=models.CharField(
        max_length=100,
        help_text='Main Maintainer',
        verbose_name='application_maintainer',
        blank=True,
        null=True,
    ...
    ip_adress = models.ForeignKey(
        to='ipam.IPAddress',
        on_delete=models.PROTECT,
        related_name='ip_adress',
        blank=True,
        null=True
    )
    csv_headers = ['name', 'slug','platform','application_type','environnement','version','application_team','link','application_maintainer','scope','undersystem','status','tenant','ip_adress']
   

    class Meta:
        ordering = ['name','slug','platform','application_type','virtual_machine','environnement','version','application_team','link','application_maintainer','scope','undersystem','status','tenant','ip_adress']

    def __str__(self):
        return self.name

    def get_absolute_url(self):
        return "{}?platform={}".format(reverse('dcim:application_list'), self.slug)
...
class ApplicationType(ChangeLoggedModel):
    """
    Platform refers to the software or firmware running on a Device. For example, "Cisco IOS-XR" or "Juniper Junos".
    NetBox uses Platforms to determine how to interact with devices when pulling inventory data or other information by
    specifying a NAPALM driver.
    ...
    csv_headers = ['name','slug','language',]
    ...
    def get_absolute_url(self):
        return "{}?applicationtype={}".format(reverse('dcim:applicationtype_list'), self.name)
...
class UnderSystem(ChangeLoggedModel):
    """
    Platform refers to the software or firmware running on a Device. For example, "Cisco IOS-XR" or "Juniper Junos".
    NetBox uses Platforms to determine how to interact with devices when pulling inventory data or other information by
    specifying a NAPALM driver.
    ...
    undersystem_type = models.ForeignKey(
        to='dcim.UndersystemType',
        on_delete=models.PROTECT,
        related_name='undersystem_type',
        blank=True,
        null=True,
        verbose_name='UnderSystem Type'
        
        )
    virtual_machine = models.ForeignKey(
        to='virtualization.VirtualMachine',
        on_delete=models.PROTECT,
        related_name='virtual_machine',
        blank=True,
        null=True,
        verbose_name='VM'
    )
    ...
    csv_headers = ['name', 'slug','platform','undersystem_type',
    'virtual_machine',
    'version',]

    class Meta:
        ordering = ['name', 'slug','platform','undersystem_type',
    'virtual_machine',
    'version']
    ...
    def get_absolute_url(self):
        return "{}?undersystem={}".format(reverse('dcim:undersystem_list'), self.slug)
...
class UnderSystemType(ChangeLoggedModel):
    """
    Platform refers to the software or firmware running on a Device. For example, "Cisco IOS-XR" or "Juniper Junos".
    NetBox uses Platforms to determine how to interact with devices when pulling inventory data or other information by
    specifying a NAPALM driver.
    ...
    def get_absolute_url(self):
        return "{}?undersystemtype={}".format(reverse('dcim:undersystemtype_list'), self.name)
