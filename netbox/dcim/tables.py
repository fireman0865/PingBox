...
class DeviceTable(BaseTable):
    ...
    acquisition_date=tables.DateColumn()
    garantee_end_date=tables.DateColumn()

    class Meta(BaseTable.Meta):
        model = Device
        fields = ('pk', 'name', 'status', 'tenant', 'site', 'rack', 'device_role', 'device_type','acquisition_date','garantee_end_date')
...
APPLICATION_VM_COUNT = """
<a href="{% url 'virtualization:virtualmachine_list' %}?application={{ record.slug }}">{{ value }}</a>
"""

APPLICATION_TYPE = """
<a href="{% url 'dcim:application_list' %}?applicationtype={{ record.name }}">{{ value }}</a>
"""
...
<a href="{% url 'dcim:application_list' %}?application={{ record.actualprofile }}">{{ value }}</a>
"""
APPLICATION_VM_COUNT = """
<a href="{% url 'virtualization:virtualmachine_list' %}?application={{ record.slug }}">{{ value }}</a>
"""
VM_SYSTEM = """
<a href="{% url 'dcim:undersystem_list' %}?application={{ record.virtual_machine }}">{{ value }}</a>
"""
APPLICATION_ACTIONS = """
<a href="{% url 'dcim:application_changelog' slug=record.slug %}" class="btn btn-default btn-xs" title="Change log">
    <i class="fa fa-history"></i>
</a>
{% if perms.dcim.change_platform %}
    <a href="{% url 'dcim:application_edit' slug=record.slug %}?return_url={{ request.path }}" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i></a>
{% endif %}
"""
VERSION_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.version }}">{{ value }}</a>
"""
APPLICATION_TEAM_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.application_team }}">{{ value }}</a>
"""

LINK_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.link }}">{{ value }}</a>
"""

APPLICATION_MAINTAINER_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.application_maintainer }}">{{ value }}</a>
"""
DATABASE_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.database }}">{{ value }}</a>
"""
DATABASE_SYSTEM_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.database }}">{{ value }}</a>
"""
LANGUAGE_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.language }}">{{ value }}</a>
"""

ENVIRONNEMENT_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.environnement }}">{{ value }}</a>
"""

DEFAULT_PROFILE_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.profilepardefaut }}">{{ value }}</a>
"""

CURRENT_PROFILE_TEMPLATE = """
<a href="{% url 'dcim:application_list' %}?application={{ record.actualprofile }}">{{ value }}</a>
"""
UNDERSYSTEM_TYPE_TEMPLATE="""
<a href="{% url 'dcim:undersystemtype_list' %}?undersystemtype={{ record.name }}">{{ value }}</a>
"""
APPLICATION_TYPE_DESCRIPTION_TEMPLATE="""
<a href="{% url 'dcim:applicationtype_list' %}?applicationtype={{ record.description }}">{{ value }}</a>
"""
SCOPE_TEMPLATE="""
<a href="{% url 'dcim:application_list' %}?application={{ record.scope }}">{{ value }}</a>
"""
UNDERSYSTEM_TEMPLATE="""
<a href="{% url 'dcim:application_list' %}?application={{ record.undersystem }}">{{ value }}</a>
"""
STATUS_TEMPLATE="""
<a href="{% url 'dcim:application_list' %}?application={{ record.status }}">{{ value }}</a>
"""
TENANT_TEMPLATE="""
<a href="{% url 'dcim:application_list' %}?application={{ record.tenant }}">{{ value }}</a>
"""
IPAM_TEMPLATE="""
<a href="{% url 'dcim:application_list' %}?application={{ record.ip_adress }}">{{ value }}</a>
"""
...
APPLICATION_TYPE_ACTIONS = """
<a href="{% url 'dcim:applicationtype_changelog' slug=record.slug %}" class="btn btn-default btn-xs" title="Change log">
    <i class="fa fa-history"></i>
</a>
{% if perms.dcim.change_platform %}
    <a href="{% url 'dcim:applicationtype_edit' slug=record.slug %}?return_url={{ request.path }}" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-pencil" aria-hidden="true"></i></a>
{% endif %}
"""
APPLICATION_TYPE_PLATFORM_TEMPLATE = """
<a href="{% url 'dcim:applicationtype_list' %}?application={{ record.platform }}">{{ value }}</a>
"""
APPLICATION_TYPE_LANGUAGE_TEMPLATE = """
<a href="{% url 'dcim:applicationtype_list' %}?application={{ record.language }}">{{ value }}</a>
"""
class ApplicationTypeTable(BaseTable):
    pk = ToggleColumn()
    ...
    platform=tables.TemplateColumn(template_code=APPLICATION_TYPE_PLATFORM_TEMPLATE, verbose_name='platform')
    
    language=tables.TemplateColumn(template_code=APPLICATION_TYPE_LANGUAGE_TEMPLATE, verbose_name='language')
...
LANGUAGE_UNDERSYSTEM_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.language }}">{{ value }}</a>
"""

UNDERSYSTEM_VERSION_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.version }}">{{ value }}</a>
"""
VERSION_MINIMUM_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.version_minimum }}">{{ value }}</a>
"""
VERSION_RECOMMENDED_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.version_recommended }}">{{ value }}</a>
"""
END_OF_SUPPORT_MINIMUM_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.end_of_support_minimum }}">{{ value }}</a>
"""
RELEASE_DATE_MINIMUM_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.release_date_minimum }}">{{ value }}</a>
"""
RELEASE_DATE_RECOMMENDED_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.release_date_recommended }}">{{ value }}</a>
"""
END_OF_SUPPORT_RECOMMENDED_TEMPLATE = """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.end_of_support_recommended }}">{{ value }}</a>
"""
UNDERSYSTEM_PLATFORM_TEMPLATE= """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.platform }}">{{ value }}</a>
"""
DATABASE_SYSTEM_PLATFORM_TEMPLATE= """
<a href="{% url 'dcim:undersystem_list' %}?undersystem={{ record.platform }}">{{ value }}</a>
"""
class UnderSystemTable(BaseTable):
    pk = ToggleColumn()
    name=tables.Column( verbose_name='Name')

    slug =tables.Column(verbose_name='Slug')
    
    platform = tables.TemplateColumn(template_code=UNDERSYSTEM_PLATFORM_TEMPLATE, verbose_name='Platform')
    
    undersystem_type = tables.TemplateColumn(template_code=UNDERSYSTEM_TYPE_TEMPLATE, verbose_name='UnderSystem')

    virtual_machine = tables.TemplateColumn(template_code=VM_SYSTEM, verbose_name='Virtual Machine')

    version= tables.TemplateColumn(template_code=UNDERSYSTEM_VERSION_TEMPLATE, verbose_name='Version')
    
    class Meta(BaseTable.Meta):
        model = UnderSystem
        fields = [
           'pk', 'name', 'slug', 'platform','undersystem_type','virtual_machine','version'
        ]
       
NAME_UNDERSYSTEMTYPE_TEMPLATE = """
<a href="{% url 'dcim:undersystemtype_list' %}?undersystemtype={{ record.name }}">{{ value }}</a>
"""
SLUG_UNDERSYSTEMTYPE_TEMPLATE = """
<a href="{% url 'dcim:undersystemtype_list' %}?undersystemtype={{ record.slug }}">{{ value }}</a>
"""
DESCRIPTION_UNDERSYSTEMTYPE_TEMPLATE = """
<a href="{% url 'dcim:undersystemtype_list' %}?undersystemtype={{ record.description }}">{{ value }}</a>
"""

class UnderSystemTypeTable(BaseTable):
    pk = ToggleColumn()
    
    name=tables.TemplateColumn(template_code=NAME_UNDERSYSTEMTYPE_TEMPLATE,verbose_name='Name')

    slug =tables.TemplateColumn(template_code=SLUG_UNDERSYSTEMTYPE_TEMPLATE,verbose_name='Slug')
    
    description=tables.TemplateColumn(template_code=DESCRIPTION_UNDERSYSTEMTYPE_TEMPLATE,verbose_name='Description')
    
    class Meta(BaseTable.Meta):
        model = UnderSystemType
        fields = [
            'pk','name', 'slug', 'description'
        ]
