...
class ApplicationListView(PermissionRequiredMixin, ObjectListView):
    permission_required = 'dcim.view_application'
    queryset = Application.objects.all()
    table = tables.ApplicationTable


class ApplicationCreateView(PermissionRequiredMixin, ObjectEditView):
    permission_required = 'dcim.add_devicetype',
    model = Application
    model_form = forms.ApplicationForm
    default_return_url = 'dcim:application_list'


class ApplicationEditView(ApplicationCreateView):
    permission_required = 'dcim.add_devicetype'


class ApplicationBulkImportView(PermissionRequiredMixin, BulkImportView):
    permission_required = 'dcim.add_devicetype'
...
class ApplicationBulkDeleteView(PermissionRequiredMixin, BulkDeleteView):
    permission_required = 'dcim.add_devicetype'
    queryset = Application.objects.all()
    table = tables.ApplicationTable
    default_return_url = 'dcim:application_list'
...
class ApplicationTypeListView(PermissionRequiredMixin, ObjectListView):
    permission_required = 'dcim.view_application'
    queryset = ApplicationType.objects.all()
    table = tables.ApplicationTypeTable


class ApplicationTypeCreateView(PermissionRequiredMixin, ObjectEditView):
    permission_required = 'dcim.add_devicetype',
    model = ApplicationType
    model_form = forms.ApplicationTypeForm
    default_return_url = 'dcim:applicationtype_list'


class ApplicationTypeEditView(ApplicationTypeCreateView):
    permission_required = 'dcim.add_devicetype'


class ApplicationTypeBulkImportView(PermissionRequiredMixin, BulkImportView):
    permission_required = 'dcim.add_devicetype'
    model_form = forms.ApplicationTypeCSVForm
    table = tables.ApplicationTypeTable
    default_return_url = 'dcim:applicationtype_list'


class ApplicationTypeBulkDeleteView(PermissionRequiredMixin, BulkDeleteView):
    permission_required = 'dcim.add_devicetype'
    queryset = ApplicationType.objects.all()
    table = tables.ApplicationTypeTable
    default_return_url = 'dcim:applicationtype_list'
...
class UnderSystemListView(PermissionRequiredMixin, ObjectListView):
    permission_required = 'dcim.view_application'
    queryset = UnderSystem.objects.all()
    table = tables.UnderSystemTable


class UnderSystemCreateView(PermissionRequiredMixin, ObjectEditView):
    permission_required = 'dcim.add_devicetype',
    model = UnderSystem
    model_form = forms.UnderSystemForm
    default_return_url = 'dcim:undersystem_list'


class UnderSystemEditView(UnderSystemCreateView):
    permission_required = 'dcim.add_devicetype'


class UnderSystemBulkImportView(PermissionRequiredMixin, BulkImportView):
    permission_required = 'dcim.add_devicetype'
    model_form = forms.UnderSystemCSVForm
    table = tables.UnderSystemTable
    default_return_url = 'dcim:undersystem_list'


class UnderSystemBulkDeleteView(PermissionRequiredMixin, BulkDeleteView):
    permission_required = 'dcim.add_devicetype'
    queryset = UnderSystem.objects.all()
    table = tables.UnderSystemTable
    default_return_url = 'dcim:undersystem_list'
...
class UnderSystemTypeListView(PermissionRequiredMixin, ObjectListView):
    permission_required = 'dcim.view_application'
    queryset = UnderSystemType.objects.all()
    table = tables.UnderSystemTypeTable


class UnderSystemTypeCreateView(PermissionRequiredMixin, ObjectEditView):
    permission_required = 'dcim.add_devicetype',
    model = UnderSystemType
    model_form = forms.UnderSystemTypeForm
    default_return_url = 'dcim:undersystemtype_list'


class UnderSystemTypeEditView(UnderSystemTypeCreateView):
    permission_required = 'dcim.add_devicetype'


class UnderSystemTypeBulkImportView(PermissionRequiredMixin, BulkImportView):
    permission_required = 'dcim.add_devicetype'
    model_form = forms.UnderSystemTypeCSVForm
    table = tables.UnderSystemTypeTable
    default_return_url = 'dcim:undersystemtype_list'


class UnderSystemTypeBulkDeleteView(PermissionRequiredMixin, BulkDeleteView):
    permission_required = 'dcim.add_devicetype'
    queryset = UnderSystemType.objects.all()
    table = tables.UnderSystemTypeTable
    default_return_url = 'dcim:undersystemtype_list'
