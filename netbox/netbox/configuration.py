...
DATABASE = {
    'NAME': 'netbox3',         # Database name
    'USER': 'netbox3',               # PostgreSQL username
    'PASSWORD': 'netbox3',           # PostgreSQL password
...
SECRET_KEY = 'BDT*-4YX=hC!WVpEijQJL8&R)#_AGI(Hldv73cmNFSzfbaU^wk'
